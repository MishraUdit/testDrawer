...
export {filterLocation as default};

// var data = items.filter(function(item,inputVal ){
//             return item.location == inputVal;
//         }).map(function({id, job, skill, location}){
//             return {id, job, skill, location};
//         });
//         console.log(data);
